...
def draw_grid(clicks, beat, actives):
    ...
    hi_hat_text = label_front.render('Hi Hat', True, colors[active[0]])
    screen.blit(hi_hat_text, (30, 30))
    snare_text = label_front.render('Snare', True, colors[active[1]])
    screen.blit(snare_text, (30, 130))
    floor_text = label_front.render('Bass Drum', True, colors[active[2]])
    screen.blit(floor_text, (30, 230))
    crash_text = label_front.render('Crash', True, colors[active[3]])
    screen.blit(crash_text, (30, 330))
    clap_text = label_front.render('Clap', True, colors[active[4]])
    screen.blit(clap_text, (30, 430))
    floor_text = label_front.render('Floor Tom', True, colors[active[5]])
