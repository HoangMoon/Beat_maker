...
snare = mixer.Sound('sounds\hi hat.WAV')
kick = mixer.Sound('sounds\hi hat.WAV')
crash = mixer.Sound('sounds\hi hat.WAV')
clap = mixer.Sound('sounds\hi hat.WAV')
tom = mixer.Sound('sounds\hi hat.WAV')
